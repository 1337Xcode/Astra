...
sleep 1
cd /data/data/com.termux/files/home/Astra && su -c chmod +x *  && su -c chmod +x /data/data/com.termux/files/home/Astra/module/* && su -c chmod +x /data/data/com.termux/files/home/Astra/pytransform/* && cd ~ && pkg update -y && pkg upgrade -y && pkg install python -y && pkg install python2 -y && pkg install cmatrix -y && pip install --upgrade pip && pkg install tsu -y &> /dev/null
sleep 1
